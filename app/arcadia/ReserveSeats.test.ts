...
import { $SeatsAlreadyTaken } from './SeatsAlreadyTaken'
...
describe('ReserveSeats', () => {
  ...
  it('failing because of nonexistent screening', async () => {
  ...
  describe('screening was created', () => {
    it('failing when screening is expired', async () => {
    ...
    it('failing when reserving out-of-bounds seats', async () => {
    ...
    describe('seats were reserved', () => {
      it('reserving already taken seats', async () => {
        await Gwt.test($ReserveSeats.handler)
          .given(
